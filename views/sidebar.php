<aside class="sidebar sidebar-right">
  ...
  <div class="block block-tips">
    <h3 class="block-title"><svg class="icon-tips"><use xlink:href="#icon-tips" /></svg> Fundraising Tips</h3>
  ...
  <div class="block block-link-list block-popular-posts">
    <h3 class="block-title"><svg class="icon-popular"><use xlink:href="#icon-popular" /></svg> Popular Posts</h3>
    <ul>
